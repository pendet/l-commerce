...
<x-app-layout>
    <x-category-list :category-list="$categoryList" class="-ml-5 -mt-1 -mr-5 px-4"/>
    ...
    <div class="flex gap-2 items-center p-3 pb-0" x-data="{
        ...
        <x-input
            ...
            type="select"
            name="sort"
            class="w-full focus:border-slate-600 focus:ring-slate-600 border-gray-300 rounded">
            ...
            <div
                ...
                >
                    ...
                    <div class="flex justify-between py-3 px-4">
                        <button class="btn-primary bg-slate-500 hover:bg-slate-600" @click="addToCart()">
                            Add to Cart
                        </button>
                    </div>
                </div>
